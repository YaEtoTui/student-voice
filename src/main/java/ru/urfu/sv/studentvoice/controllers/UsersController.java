...
//        ActionResult result = userService.updateUser(username, User
//                .builder()
//                .username(username)
//                .password(password)
...
//
//        if (result.isSuccess() && Roles.PROFESSOR.equals(user.getRole())) {
//            result = professorService.createProfessor(username, user.getAdditionalData().get(Parameters.PROFESSOR_NAME));
//        }
//
//        model.addAttribute(ROLES, List.of(ADMIN, PROFESSOR));
//        model.addAttribute(RESULT, result);
